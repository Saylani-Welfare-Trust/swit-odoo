...
class ResConfigSettings(models.TransientModel):
    ...
    account_default_pos_neutral_receivable_account_id = fields.Many2one(string='Default Account Neutral (PoS)', related='company_id.account_default_pos_neutrnal_receivable_account_id', readonly=False, check_company=True)
