...
class WelfareDocument(models.Model):
    ...
    def action_view_document(self):
        ...
        # For images, open in modal preview
        if self.mimetype and self.mimetype.startswith('image/'):
            return {
                'type': 'ir.actions.act_window',
                'name': 'View Document - ' + (self.name or 'Document'),
            ...
            # For PDFs and other documents, download/view directly
            return {
    ...
    def action_delete(self):
        ...
        # Return to the welfare form view with a success notification
        return {
            'type': 'ir.actions.act_window',
            'res_model': 'welfare',
            'res_id': welfare_id,
