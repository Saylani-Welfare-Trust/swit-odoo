...
class Welfare(models.Model):
    ...
    donee_house_status = fields.char(string="Residential Status, Does he own the house or live in a rented house?")

    number_of_children = fields.Integer(string="Number of Children")

    number_of_sons = fields.Integer(string="Number of Sons")

    number_of_daughters = fields.Integer(string="Number of Daughters")

    children_education = fields.char(string="Children's Education, Where do the children study?")

    donee_issues = fields.Text(string="Donee Issues", help="What are the issues/concerns related to the donee?")
