...
class DisbursementRequest(models.Model):
    ...
    def check_recurring_disbursement_ids(self, data):
        ...
        return {
            ...
            'disbursement_ids': [{
                    ...
                    'collection_point': recurring_disbursement_id.collection_point.title(),
    ...
    def mark_as_disbursed(self, data):
        ...
        disbursement_id = self.env[data['res_model']].sudo().browse(int(data['disbursement_id']))
        if not disbursement_id:
            return {
                "status": "error",
                "body": "Record not found against Disbursement Number "+str(data['disbursement_number']),
            }
        elif disbursement_id.state == 'disbursed':
            return {
                "status": "error",
                "body": "Record has already been Disbursed",
            }
        
        disbursement_id.action_disbursed()
