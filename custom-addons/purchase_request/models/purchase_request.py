...
class PurchaseRequest(models.Model):
    ...
    def _compute_assigned_to(self):
        for rec in self:
            # navigate from requested_by user -> employee -> parent employee -> user
            manager = (
                    rec.requested_by.employee_id
                    and rec.requested_by.employee_id.parent_id
                    and rec.requested_by.employee_id.parent_id.user_id
            )
            rec.assigned_to = manager or False
