...
class TestBoardUI(HttpCase):
    ...
    def _seed_board(self):
        ...
        self.env["res.partner"].create([
            {"name": "Demo Co A", "is_company": True, "country_id": au.id if au else False, "color": 10},
            {"name": "Demo Co B", "is_company": True, "color": 20},
            {"name": "Demo Person", "is_company": False, "color": 30},
        ])
