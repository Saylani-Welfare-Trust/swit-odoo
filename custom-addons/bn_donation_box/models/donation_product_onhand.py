...
class DonationProductOnhand(models.Model):
    ...
    _auto = False  # Don't create a database table
    _order = 'location_name, product_name'
    
    # These fields are only for display, not stored in database
    ...
    def _get_onhand_data(self):
        ...
        # Add caching to avoid recalculation on every call
        ...
        # Get only internal locations (physical storage)
        ...
        records = []
        # Use a counter for temporary ID
        temp_id = 1
        ...
        for product_tmpl in donation_products:
            ...
            for product in product_variants:
                ...
                for location in locations:
                    ...
                    on_hand_qty = quants[0]['quantity'] if quants else 0.0
    ...
    @api.model
    def _apply_filter(self, record, field, operator, value):
        ...
        if operator == '=':
            ...
            # For hierarchical fields - you may need custom logic
            return True
