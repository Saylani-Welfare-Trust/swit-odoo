...
class ProductStockMoveLineModel(models.Model):
    _name = 'product.stock.move.lines'
    _description = 'Product Stock Move Line Model'
    ...
    def create(self, vals_list):
        for vals in vals_list:
            if vals.get('name') == 'New':
                vals['name'] = self.env['ir.sequence'].next_by_code('product.stock.move.lines.sequence')
        return super(ProductStockMoveLineModel, self).create(vals_list)
