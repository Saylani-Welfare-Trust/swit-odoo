...
class AmountCurrencyBoxLinesModel(models.Model):
    _name = 'amount.currency.box.lines'
    _description = 'Amount Currency Box Line Model'
    ...
    def create(self, vals_list):
        for vals in vals_list:
            if vals.get('name') == 'New':
                vals['name'] = self.env['ir.sequence'].next_by_code('amount.currency.box.lines.sequence')
        return super(AmountCurrencyBoxLinesModel, self).create(vals_list)
